...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = UserRegistration.Builder.class)
public class UserRegistration extends localhost.localhost.models.BaseModel {
  ...
  public static class Builder extends localhost.localhost.models.BaseModel.Builder {
    ...
    public UserRegistration buildWithoutValidation() {
