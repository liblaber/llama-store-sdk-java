...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = ApiTokenRequest.Builder.class)
public class ApiTokenRequest extends localhost.localhost.models.BaseModel {
  ...
  public static class Builder extends localhost.localhost.models.BaseModel.Builder {
    ...
    public ApiTokenRequest buildWithoutValidation() {
      return new ApiTokenRequest(this);
    }
  ...
  ApiTokenRequest(Builder builder) {
    super(builder);
