...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = LlamaCreate.Builder.class)
public class LlamaCreate extends localhost.localhost.models.BaseModel {
  ...
  public static class Builder extends localhost.localhost.models.BaseModel.Builder {
    ...
    public LlamaCreate buildWithoutValidation() {
      return new LlamaCreate(this);
    }
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("rating")
  private final java.lang.Long rating;

  LlamaCreate(Builder builder) {
    super(builder);
