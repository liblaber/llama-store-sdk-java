...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      Object response = client.llamaPictureService.createLlamaPicture(268867026);
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaPictureService.getLlamaPictureByLlamaId(385251427);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaPictureService.deleteLlamaPicture(302850788);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaPictureService.updateLlamaPicture(355732687);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaService.getLlamaById(875459295);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaService.deleteLlama(247511923);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaService.updateLlama(644317020);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
