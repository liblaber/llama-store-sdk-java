...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      Object response = client.llamaPictureService.createLlamaPicture(571817782);
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaPictureService.getLlamaPictureByLlamaId(270962007);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaPictureService.deleteLlamaPicture(599899326);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaPictureService.updateLlamaPicture(923529541);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaService.getLlamaById(203165959);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaService.deleteLlama(880146027);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
      Object response = client.llamaService.updateLlama(487007454);
      System.out.println(response);
    } catch (ApiException e) {
      e.printStackTrace();
    }
