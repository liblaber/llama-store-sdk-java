...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
        Object response = client.llamaPictureService.createLlamaPicture(281394376);
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
        Object response = client.llamaPictureService.getLlamaPictureByLlamaId(792891401);
        System.out.println(response);
    } catch(ApiException e) {
        e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
        Object response = client.llamaPictureService.deleteLlamaPicture(884304640);
        System.out.println(response);
    } catch(ApiException e) {
        e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
        Object response = client.llamaPictureService.updateLlamaPicture(548640660);
        System.out.println(response);
    } catch(ApiException e) {
        e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
        Object response = client.llamaService.getLlamaById(668645938);
        System.out.println(response);
    } catch(ApiException e) {
        e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
        Object response = client.llamaService.deleteLlama(269997485);
        System.out.println(response);
    } catch(ApiException e) {
        e.printStackTrace();
    }
...
public class Main {
  ...
  public static void main(String[] args) {
    Llamastore client = new Llamastore(System.getenv("LLAMASTORE_BEARER_TOKEN"));
    try {
        Object response = client.llamaService.updateLlama(896164855);
        System.out.println(response);
    } catch(ApiException e) {
        e.printStackTrace();
    }
