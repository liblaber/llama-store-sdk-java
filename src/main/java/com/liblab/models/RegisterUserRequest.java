...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = RegisterUserRequest.Builder.class)
public class RegisterUserRequest extends com.liblab.models.BaseModel {
  ...
  public static class Builder extends com.liblab.models.BaseModel.Builder {
    ...
    public RegisterUserRequest buildWithoutValidation() {
  ...
  RegisterUserRequest(Builder builder) {
    super(builder);
