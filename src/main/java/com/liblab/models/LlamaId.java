...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = LlamaId.Builder.class)
public class LlamaId extends com.liblab.models.BaseModel {
  ...
  public static class Builder extends com.liblab.models.BaseModel.Builder {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("id") private java.lang.Long id;
    ...
    public LlamaId buildWithoutValidation() {
      return new LlamaId(this);
    }
  ...
  @com.fasterxml.jackson.annotation.JsonProperty("id") private final java.lang.Long id;

  LlamaId(Builder builder) {
    super(builder);
