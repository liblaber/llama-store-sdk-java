...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = CreateLlamaRequest.Builder.class)
public class CreateLlamaRequest extends com.liblab.models.BaseModel {
  ...
  public static class Builder extends com.liblab.models.BaseModel.Builder {
    ...
    public CreateLlamaRequest build() {
    ...
    public CreateLlamaRequest buildWithoutValidation() {
      return new CreateLlamaRequest(this);
    }
  ...
  CreateLlamaRequest(Builder builder) {
    super(builder);
