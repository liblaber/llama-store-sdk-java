...
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(builder = Llama.Builder.class)
public class Llama extends com.liblab.models.BaseModel {
  ...
  public static class Builder extends com.liblab.models.BaseModel.Builder {
    ...
    static {
      java.lang.String[][] requiredFieldsGroups =
          new java.lang.String[][] {
            new java.lang.String[] {"age", "color", "id", "name", "rating"}
          };
    ...
    public Llama buildWithoutValidation() {
